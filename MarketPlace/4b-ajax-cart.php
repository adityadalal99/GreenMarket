...
switch ($_POST['req']) {
  ...
  case "show":
    ...
    <form id="cart-checkout" method="post" action="http://localhost:8080/Green_Market_Updated/Payment.html" onsubmit="return cart.checkout(<?= $total ?>);" >
      <input type="hidden" id="co_name" required value="John Doe"/>
      <input type="hidden" id="co_email" required value="john@doe.com"/>
